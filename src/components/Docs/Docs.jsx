            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                ...
                {activeTab === 'categories' && (
                  <>
                  <div className="bg-info/10 border border-info/20 rounded-lg p-4 flex gap-2 items-start mb-6">
                    <Info className="h-5 w-5 text-info mt-0.5 flex-shrink-0" />
                    <p className="text-sm">Click on the copy icon to copy the complete URL. Remember to replace <code className="bg-base-200 px-1 py-0.5 rounded">&lt;yourApiKey&gt;</code> with your generated API key.</p>
                  </div>
